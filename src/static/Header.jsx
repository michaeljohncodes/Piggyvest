...
function Header() {
  const [dropDownSave, setDropDownSave] = useState(false);
          ...
          <section className=" flex ">
            ...
            <main className=" flex  mx-12 gap-9 items-center font-medium max-tablet:hidden">
              <div className="">
                <nav
                  onMouseOver={() => {
                    setDropDownSave(true);
                  }}
                  onMouseOut={() => {
                    setDropDownSave(false);
                  }}
                ...
                <div
                  ...
                  className={
                    !dropDownSave
                      ? "hidden"
                      : "w-[500px] h-auto fixed flex justify-between items-start rounded-[10px] shadow shadow-gray-500 p-[5px] bg-[#f2f7f8] ml-[-20px]"
                  }
                >
              ...
              <div>
                <nav
                  ...
                  onMouseOver={() => {
                    setDropDownResource(true);
                  }}
                  onMouseOut={() => {
                    setDropDownResource(false);
                  }}
                >
                  Resources
                ...
                <div
                  ...
                  className={
                    !dropDownResource
                      ? "hidden"
                      : "w-[500px] h-auto fixed flex justify-between items-start rounded-[10px] shadow shadow-gray-500 p-[20px] bg-[#f2f7f8] ml-[-370px]"
                  }
                >
                  <div className="w-[50%]  flex flex-col gap-y-[30px]">
                    <div className=" flex justify-between items-center p-[10px] gap-x-[10px]">
